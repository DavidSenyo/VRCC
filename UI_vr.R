...
vrcc_projects <- read_csv("vrcc.csv", locale = locale(encoding = "Latin1") )
...
vrcc_projects$longitude <- as.numeric(vrcc_projects$longitude)
vrcc_projects$latitude <- as.numeric(vrcc_projects$latitude)
